export const RouteMappings = [
    ...
    {
        route: '/movies/dashboard',
        filePath: './containers/movies/dashboard'
    },
    {
        route: '/movies/browseMovies',
        filePath: './containers/movies/browseMovies'
    },
    {
        route: '/movies/movieDetail',
        filePath: './containers/movies/movieDetail'
    },
    {
        route: '/movies/add',
        filePath: './containers/movies/add'
    },
    {
        route: '/movies/update',
